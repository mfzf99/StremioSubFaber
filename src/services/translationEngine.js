...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} into spoken, conversational Malaysian ${targetLabel} without regional dialects. NEVER mirror or copy the ${sourceLabel} sentence structure.`,
