...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} into standard conversational Malaysian ${targetLabel}. Accurately convey the meaning and idioms, not literal words.`,
