...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to ${targetLabel}. Accurately convey the meaning and idioms, not literal words, into spoken, conversational ${targetLabel} that matches the scene's tone.`,
