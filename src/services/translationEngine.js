...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} into standard conversational Malaysian ${targetLabel}. Adapt idioms and cultural references into natural equivalents. Match the original speaker's tone, emotion, and character register.`,
