...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag. Accurately convey the meaning in natural spoken ${targetLabel} dialogue rather than copy the ${sourceLabel} sentence structure.`,
