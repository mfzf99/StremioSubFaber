...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} into natural conversational ${targetLabel}. NEVER mirror or copy the ${sourceLabel} sentence structure.`,
