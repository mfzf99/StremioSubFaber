...
const PROMPT_TEMPLATES = {
  ...
  primary: (targetLabel, sourceLabel) => 
    `Translate the text inside each <s id="N"> tag from ${sourceLabel} to spoken ${targetLabel} dialogue. NEVER mirror or copy the original sentence structure. Grasp the intended meaning and rebuild each line using natural ${targetLabel} word order, grammar, and rhythm as a native speaker would speak it in that exact situation.`,
